    ...
    override val simpleName: String?
        get() {
            val qualifiedName = this.qualifiedName
                    ?: return getLocalClassSimpleName(this.typeInfo)

            return qualifiedName.substringAfterLast(".")
        }

    override val qualifiedName: String?
        get() = getQualifiedName(this.typeInfo)
...
@SymbolName("Kotlin_TypeInfo_getLocalClassSimpleName")
private external fun getLocalClassSimpleName(typeInfo: NativePtr): String?

@SymbolName("Kotlin_TypeInfo_getQualifiedName")
private external fun getQualifiedName(typeInfo: NativePtr): String?
